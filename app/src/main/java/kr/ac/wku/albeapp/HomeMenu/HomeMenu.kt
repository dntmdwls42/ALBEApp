...
class HomeMenu : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val friendList: List<Friendlist.Friend> = listOf(
            Friendlist.Friend(R.drawable.ic_launcher_foreground, "예시1", "010-1221-0001", 0),
            Friendlist.Friend(R.drawable.ic_launcher_background, "예시2", "010-1221-0002", 1),
            Friendlist.Friend(R.drawable.ic_launcher_background, "예시3", "010-1221-0003", 2),
